...
export const BroomIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 15.375l4.87-4.87a.75.75 0 011.06 0l2.87 2.87a.75.75 0 010 1.06l-4.87 4.87a.75.75 0 01-1.06 0l-2.87-2.87a.75.75 0 010-1.06z" />
